...
from finance_manager.models import Category, Expense, Income
from finance_manager.serializers import CategorySerializer, ExpenseSerializer, IncomeSerializer
